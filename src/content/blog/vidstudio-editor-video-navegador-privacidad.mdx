...
La mayoría de editores de video en línea suben tu material a servidores remotos. Eso introduce latencia, costes de infraestructura y, sobre todo, una barrera de privacidad. VidStudio demuestra que el navegador ya tiene suficientes piezas para montar una cadena de procesamiento decente sin salir del dispositivo.
...
La API de WebCodecs permite decodificar video directamente en el navegador usando el acelerador de hardware cuando está disponible. Esto hace que mover la cabeza lectora por la línea de tiempo sea fluido, porque no dependes de un servidor que genere previsualizaciones.
