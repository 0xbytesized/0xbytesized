...
Todos los transfers USB se modelan como struct que poseen sus propios búferes de memoria. Cuando un transfer está en vuelo, la propiedad conceptual del búfer pasa al kernel del SO. Si algo sale mal durante el desmontaje de un dispositivo, el código elige **perder memoria** antes que recuperar un puntero colgante — una decisión explícita documentada y vinculada a [faultlore.com/blah/everyone-poops](https://faultlore.com/blah/everyone-poops/).
