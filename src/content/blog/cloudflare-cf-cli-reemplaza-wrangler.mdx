...
# Zonas
cf zones list
cf zones create-zones-post --name nuevo-dominio.com --type full
...
La ventaja es que la API local **mira** la API remota. Lo que funciona en local funciona en producción, y viceversa. No hay sorpresas al hacer deploy.
