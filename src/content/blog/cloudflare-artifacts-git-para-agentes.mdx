...
- **Import desde cualquier remoto**: importa un repositorio de GitHub con una sola llamada.
...
# (el CLI exacto puede variar según la versión de artifact-fs)
artifactfs mount https://github.com/mi-org/repo-grande /mnt/repo

# El agente puede empezar a trabajar inmediatamente
# Los archivos se van hidratando en background
ls /mnt/repo/src/         # El árbol ya está disponible
cat /mnt/repo/package.json  # Se bloquea brevemente si no está hidratado
```
