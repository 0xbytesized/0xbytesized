...
compañeros ponían la cara de "no hoy", sabes el problema: los PRs enormes son
...
Una *stack* es una cadena de pull requests donde cada PR targets la rama del PR
...
Requiere GitHub CLI (`gh`) v2.0+ y Git 2.20+. El flujo de trabajo básico es
sencillísimo:
...
Para el día a día, `gh stack sync` es el navaja suiza: hace fetch, fast-forward
...
La constraint clave: se mergea de abajo hacia arriba. No puedes mergear el PR
